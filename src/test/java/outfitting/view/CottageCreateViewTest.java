...
import outfitting.controller.CottageCreateControllerMock;
...
public class CottageCreateViewTest {
	...
	{
		CottageCreateView view = new CottageCreateView();
		CottageCreateControllerMock controller = new CottageCreateControllerMock();
